      ...
      <main className="bg-dark-blue">
        ...
        <Container id="hero" fluid className="v-full z-999 py-5 px-md-5 px-4">
          <Row className="justify-content-center align-items-center d-flex mx-xl-5 mx-lg-3 py-lg-0 py-md-5 py-5 px-xl-5">
            ...
            <Image fluid className="hero-img mt-5" src="/landing-mock.svg" alt="Image of Causable app"/>
            </Col>
        ...
        <Container fluid className="v-full bg-dgnl c-drag px-xl-5 pb-5">
          <Row className="justify-content-center align-items-center d-flex px-md-5 px-4 pe-lg-0 pe-md-0 pb-5 mx-xl-5 mx-lg-4">
            ...
            <p className="text-white mb-3 bold ms-1">Causable’s electronic raffle technology and marketing platform provides your charitable organizations with unparalleled fundraising capacity in a secure and interactive manner.</p>
            <object className="d-block d-sm-none" type="image/svg+xml" data="/Causable-Animation-ENG.svg" alt="Causable platform animation"/>
            <p className="text-white mb-4 ms-1 pe-xl-5">Our mobile playing app allows anyone in your area to play your electronic raffle via their mobile device or computer --  expanding your raffle’s reach and fundraising potential.</p>
              <div className="d-none d-sm-block">
              <Link href="#">
                <Button className="btn btn-blue tight-drop d-arrow ms-1 mb-md-3 mb-0">
                  WHAT YOU GET
                </Button>
              </Link>
              </div>
              ...
              <Link href="#">
                <Button className="btn btn-blue tight-drop d-arrow ms-1 pb-5 mb-5 mb-0 d-block d-sm-none">
                  WHAT YOU GET
                </Button>
              </Link>
              </div>
            ...
            <Col xl={7} lg={7} md={7} sm={12} className="pb-0 mb-0 mb-5 justify-content-center ps-md-0 p-0">
        ...
        <Container fluid className="v-full z-0 bg-grad c-drag px-xl-5 pb-5">
          <Row className="justify-content-center align-items-center d-flex px-md-5 px-4 pe-lg-0 pe-md-0 pb-5 mx-xl-5 mx-lg-4">

            <Col xl={5} lg={5} md={5} sm={12} className="px-xl-5 ps-lg-4 pt-md-5 mb-lg-5 mb-md-1 mb-0 pb-md-5 pb-2 ">
            <h6 className="text-blue text-drop mb-3 mt-5">WHAT YOU GET</h6>
            <h3 className="text-white text-drop mb-3">The Game</h3>
            <p className="text-white mb-3 bold ">Causable’s electronic raffle technology and marketing platform provides your charitable organizations with unparalleled fundraising capacity in a secure and interactive manner.</p>
            <p className="text-white mb-3 ">Users can sign up, buy their numbers and play each week. The platform uses a random number generator to select a number for each draw and notifies the ticket holder. The platform is secure and eliminates financial errors, the need for cumbersome accounting, and the need for physical ticket sales and tracking.</p>
            </Col>
